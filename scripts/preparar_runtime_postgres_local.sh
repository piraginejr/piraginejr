...
env["POWER_CHURCH_RECEIPT_AUTOMATION_ENABLED"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_ENABLED") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_ENABLED") or "true"
env["POWER_CHURCH_RECEIPT_AUTOMATION_FORCE"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_FORCE") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_FORCE") or "false"
env["POWER_CHURCH_RECEIPT_AUTOMATION_INTERVAL_SECONDS"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_INTERVAL_SECONDS") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_INTERVAL_SECONDS") or "300"
env["POWER_CHURCH_RECEIPT_AUTOMATION_DRAIN_QUEUE"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_DRAIN_QUEUE") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_DRAIN_QUEUE") or "true"
env["POWER_CHURCH_RECEIPT_AUTOMATION_LIMIT"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_LIMIT") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_LIMIT") or "40"
env["POWER_CHURCH_RECEIPT_AUTOMATION_SLEEP_SECONDS"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_SLEEP_SECONDS") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_SLEEP_SECONDS") or "3"
env["POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_EVERY"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_EVERY") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_EVERY") or "40"
env["POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_SECONDS"] = local_env.get("POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_SECONDS") or env.get("POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_SECONDS") or "60"
...
for key in [
    ...
    "POWER_CHURCH_RECEIPT_AUTOMATION_ENABLED",
    "POWER_CHURCH_RECEIPT_AUTOMATION_FORCE",
    "POWER_CHURCH_RECEIPT_AUTOMATION_INTERVAL_SECONDS",
    "POWER_CHURCH_RECEIPT_AUTOMATION_DRAIN_QUEUE",
    "POWER_CHURCH_RECEIPT_AUTOMATION_LIMIT",
    "POWER_CHURCH_RECEIPT_AUTOMATION_SLEEP_SECONDS",
    "POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_EVERY",
    "POWER_CHURCH_RECEIPT_AUTOMATION_PAUSE_SECONDS",
